...
xdescribe('WelcomeComponent', () => {
    ...
    it('get full calendar event successfully', async () => {
        await setup();
        await fixture.whenStable().then(() => {
            ...
            if (
                ...
                component.calendarOptions.dateClick
            ) {
                ...
                expect(window.alert).toHaveBeenCalledWith(
                    'Clicked on date : test'
                );
            }
        });
    });

    it('handles get full calendar event when empty response ', fakeAsync(async () => {
        await setup({
    ...
    it('handles get full calendar event when error response', fakeAsync(async () => {
        await setup({
            // Let the API report a failure
