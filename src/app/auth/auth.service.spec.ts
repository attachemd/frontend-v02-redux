...
describe('AuthService', () => {
    ...
    describe("User login",
        () => {
            it('User login successfully', () => {
                ...
                sut.login(validAuthData).subscribe(
                    (isLoadingState) => {
                        actualIsLoadingState = isLoadingState;
                    }
                );
            ...
            it('Login passes through user form fields empty', () => {
                ...
                sut.login(invalidAuthData).subscribe(
                    (isLoadingState) => {
                        actualIsLoadingState = isLoadingState;
                    }
                );
    ...
    describe(
        ...
        () => {
            it('Refresh access token successfully', () => {
                ...
                sut.refreshTokenOrDie().subscribe(
                    (isAuth) => {
                        actualIsAuth = isAuth;
                    }
                );
        ...
        () => {
            it(
                ...
                () => {
                    ...
                    sut.isBothTokensAlive().subscribe(
                        (isBothTokensAlive) => {
            ...
            it(
                'Check REFRESH tokens alive',
                () => {
                    spyOn<any>(jwtHelper, 'isTokenExpired')
                        .and.returnValue(true);
                    spyOn<any>(sut, 'refreshTokenOrDie')
    ...
    describe(
        ...
        () => {
            it(
                'Check ACCESS token validation successfully',
                () => {
                    let access = "test"
            ...
            it(
                'Check ACCESS token validation passes through invalid token',
                () => {
                    let access = "test"
                    spyOn(window.localStorage, 'getItem')
                        .and.returnValue(access);
            ...
            it(
                'Check ACCESS token validation passes through empty token',
                () => {
                    let access = ""
                    spyOn(window.localStorage, 'getItem')
                        .and.returnValue(access);
